...
I am  a I am a manager, I have a little experience in social media discord-style places. I have been dealing with this business for 3-4 years.
                </p>
              </div>
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="ardaegehatıl" src={`https://cdn.discordapp.com/attachments/980905386049667143/1029736683459051550/20221012_154519.png`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
            ...
            ? repositories
              ? repositories
                  ...
                  .map((_, __) => (
                    <a
                      key={__}
                      href={`https://github.com/ardaege355/`+_.name}
                      target="_blank"
                      rel="noreferrer"
